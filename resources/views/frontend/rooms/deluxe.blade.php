    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <p class="pb-3">
                    Our Deluxe rooms have enough space to relax and enjoy. The rooms are interlocking with all of the
...
<br>
        ...
        <hr>
        <h3 class="font-weight-bolder text-primary  pt-3 pb-5">Deluxe Facilities</h3>
