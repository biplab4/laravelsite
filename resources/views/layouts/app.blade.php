...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand" href="#">
            <img src="images/Logo Shambhu_2.jpg" width="60" height="60" style="position: absolute" alt="">
        </a>
        <div class="container-fluid">
                ...
                <li class="dropdown font-weight-bold">
                    <a class="dropdown-toggle" data-toggle="dropdown" href=""> SERVICES
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('service') }}">Multi-Cuisine Restro</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><button type="submit" class="btn btn-info"> Book </button></li>
    ...
    <hr>
    <!-- Footer -->
    <footer class="fixed page-footer">
        ...
        <div class="container-fluid text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-md-0 mt-3">
                    ...
                    <a class="navbar-brand" href="#">
                        <img src="images/Logo Shambhu_2.jpg" width="55" height="55" class="img" alt="">
                    </a>
                ...
                <div class="col-md-3 mb-md-0 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="mailto:hotelshrestharesidency@gmail.com"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="16" fill="currentColor" class="bi bi-envelope-open-fill"
                                    viewBox="0 0 16 16">
                                    <path
        ...
        <div class="footer-copyright text-center py-3">© 2023 Copyright:
            <a href="/"> HotelShresthaResidency.com</a>
        </div>
        <!-- Copyright -->
